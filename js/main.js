...
var polygonJSONFile = "data/mali_burkinafaso_senegal.geojson";

//change the center of your map in setView
var centerLatitude = 15, centerLongitude = -7;
...
var attNames = ["Political Trust", "Linguistic Fractionalization", "Population Density", "Health Index", "Education Index", "Income Index"];
...
function moveLabel() {
  var x = d3.event.clientX+100; //horizontal label coordinate based mouse position stored in d3.event
